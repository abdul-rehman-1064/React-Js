...
function Card({ id , name , price , image }) {
  return (
    <div className="flex font-serif bg-white shadow-lg rounded-lg overflow-hidden max-w-3xl mx-auto my-8">
  <div class="flex-none w-52 relative">
    <img src = {image} alt="" className="absolute mt-8 ml-2 inset-0 w-full h-[240px] object-cover rounded-lg " loading="lazy" />
  </div>
  <form className="flex-auto p-6">
    <div clasclassNames="flex flex-wrap items-baseline">
      ...
      <div className="text-xs leading-6 font-medium uppercase text-red-900">
        {id}
      </div>
    </div>
    <div className="flex items-baseline mt-4 mb-6 pb-6 border-b border-slate-200">
      <div className="space-x-1 flex text-sm font-medium">
        ...
        <label>
          ...
          <div claclassNamess="w-7 h-7 rounded-full flex items-center justify-center text-slate-500 peer-checked:bg-slate-100 peer-checked:text-slate-900">
            L
          </div>
        </label>
        <label>
