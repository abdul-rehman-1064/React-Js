...
const ProductListView = ({product}) => {
  ...
  return (
    <div className='space-y-4 mt-2 rounded-md'>
      <div className='bg-gray-100  dark:bg-[#111111] flex gap-7 items-center p-2 rounded-md'>
        ...
        <div className='space-y-2'>
          ...
          <button onClick={()=>addToCart(product)} className='bg-[#e6b054ee] text-white px-3 py-1 rounded-md'>Add to Cart</button>
        </div>
      </div>
    </div>
  )
